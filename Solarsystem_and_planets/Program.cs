...
class Astronomy
{
    static void Main()
    {
        List<SpaceObject> solarSystem = new List<SpaceObject>
        {
            ...
            new Moon("The Moon") { Orbiting=(new Planet("Earth")), OrbitRadius=384400F, OrbitPeriod=27.3F, ObjectRadius=1737F, RotationalPeriod=27.3F, ObjectColor=Color.White },
            ...
            new Moon("Ganymede") { Orbiting=(new Planet("Jupiter")), OrbitRadius=1070400F, OrbitPeriod=7.15F, ObjectRadius=2634F, RotationalPeriod=7.15F, ObjectColor=Color.Gray },
            new Moon("Callisto") { Orbiting=(new Planet("Jupiter")), OrbitRadius=1882700F, OrbitPeriod=16.69F, ObjectRadius=2410F, RotationalPeriod=16.69F, ObjectColor=Color.Gray },
            ...
            new Moon("Titan") { Orbiting=(new Planet("Saturn")), OrbitRadius=1221870F, OrbitPeriod=15.95F, ObjectRadius=2575F, RotationalPeriod=15.95F, ObjectColor=Color.Orange },
        ...
        else
        {
            ...
            if (planet != null)
            {
                ...
                foreach (var obj in solarSystem)
                {
                    if (obj is Moon moon && ((Moon)obj).Orbiting.Name == planet.Name)
                    {
                        moon.Draw();
